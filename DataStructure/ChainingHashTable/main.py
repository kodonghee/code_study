...
class HashTable:
    ...
    def look_up_value(self, key):
        ...
        """
        if self._table[self._hash_function(key)].find_node_with_key(key) is None:
            return None
        else:
            return self._table[self._hash_function(key)].find_node_with_key(key).value
    ...
    def insert(self, key, value):
        ...
        """
        if self.look_up_value(key) is None:
